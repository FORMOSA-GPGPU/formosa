...
set(softfloat_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/softfloat")
...
set(FILES "")
foreach(file ${OBJS_PRIMITIVES})
  list(APPEND FILES "${softfloat_SOURCE_DIR}/source/${file}")
endforeach()
foreach(file ${OBJS_OTHERS})
  list(APPEND FILES "${softfloat_SOURCE_DIR}/source/${file}")
endforeach()
foreach(file ${OBJS_SPECIALIZE})
  list(APPEND FILES "${softfloat_SOURCE_DIR}/source/RISCV/${file}")
endforeach()

# Define the static library target
add_library(softfloat STATIC ${FILES})
...
target_include_directories(softfloat
  PUBLIC "${softfloat_SOURCE_DIR}/source/include"
  PRIVATE "${softfloat_SOURCE_DIR}/source/RISCV"
  PRIVATE "${softfloat_SOURCE_DIR}/build/Linux-x86_64-GCC"
)
