...
#define MATCH_FSA_BAR 0x102b
#define MASK_FSA_BAR 0xffffffff
#define MATCH_FSA_PRI_LOWER 0x302b
#define MASK_FSA_PRI_LOWER 0xfc0fffff
#define MATCH_FSA_PRI_RAISE 0x502b
#define MASK_FSA_PRI_RAISE 0xfc0fffff
#define MATCH_FSA_PRI_RESET 0x200002b
#define MASK_FSA_PRI_RESET 0xffffffff
...
DECLARE_INSN(fsa_bar, MATCH_FSA_BAR, MASK_FSA_BAR)
DECLARE_INSN(fsa_pri_lower, MATCH_FSA_PRI_LOWER, MASK_FSA_PRI_LOWER)
DECLARE_INSN(fsa_pri_raise, MATCH_FSA_PRI_RAISE, MASK_FSA_PRI_RAISE)
DECLARE_INSN(fsa_pri_reset, MATCH_FSA_PRI_RESET, MASK_FSA_PRI_RESET)
