...
#include "nanolibc/c/libc_internals.h"
...
/* Return a pointer aligned to NNLC_MALLOC_ALIGNMENT at or after
...
static void *align_after(void *mem, size_t reserved_space) {
  ...
  return (void *)(pad_for_alignment((intptr_t)p) &
                  ~(intptr_t)NNLC_ALIGNMENT_MASK);
}
